...
public class TestWarMap : MonoBehaviour
{
    ...
    public Summoners.Memewars.UI_WarMember prefab = null;
    ...
    public void Arrange()
    {
        ...
        if (rects != null && count > 0 && root != null)
        {
            ...
            for (int i = 0; i < rects.Count; i++)
            {
                ...
                Summoners.Memewars.UI_WarMember warMember = rects[i].GetComponentInChildren<Summoners.Memewars.UI_WarMember>(true);
                if (warMember != null)
                {
