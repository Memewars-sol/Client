namespace Summoners.Memewars
{
    ...
    public class StartLoading : MonoBehaviour
    {
        ...
        [SerializeField] private Button _walletConnect = null;
        ...
        [SerializeField] private GameObject Web3Auth = null;
        ...
        private void Start()
        {
            Web3Auth.gameObject.SetActive(false);
            ...
            _walletConnect.onClick.AddListener(ConnectWallet);
        ...
        {
            _walletConnect.gameObject.SetActive(false);
            HideAll();
